...
public interface Autoconstant {
	...
	String propertyfile="../SDET_19/src/test/resources/CommonData.properties";
	String xml="../SDET_19/src/test/resources/CommonDAta.xml";
	String excel="/SDET_19/src/test/resources/Excel.xlsx";
